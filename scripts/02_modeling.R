...
# ** Performance Object ----
performance_h2o <- h2o.performance(stacked_ensemble_h2o, newdata = test_tbl_h2o)

# ** Key Metrics ----
h2o.auc(performance_h2o)

h2o.confusionMatrix(performance_h2o) %>% as_tibble()

h2o.precision(performance_h2o)

# ** H2o Metric ----
performance_tbl <- h2o.metric(performance_h2o) %>% 
  as_tibble()
