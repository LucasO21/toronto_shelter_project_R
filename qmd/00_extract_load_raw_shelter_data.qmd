...
This notebook uses the [Toronto Opendata](https://github.com/sharlagelfand/opendatatoronto) 
R package to extract daily data on shelter occupancy and overnight service occupancy 
for the city of Toronto. The package pulls data from 
[Toronto Opendata](https://open.toronto.ca/dataset/daily-shelter-overnight-service-occupancy-capacity/) 
which provides an API to access shelter occupancy data.
